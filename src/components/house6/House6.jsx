    ...
    <div className="container">
      <Carousel>
        <Carousel.Item interval={1000} className="sized">
          <img src="./assets/house1.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/house2.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/house3.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/house4.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/house5.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/house6.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/house7.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/house8.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/house9.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/house10.webp" alt="Featured-House" />
        </Carousel.Item>
      </Carousel>
      <div className="amenities-conatiner">
        <h3>Villa in Kilima Mbogo</h3>
        <h3> $2,100/month</h3>
        ...
        <div className="description">
          <h3>Description</h3>
          <p>
            Form and function blend wonderfully together in this
            Arts-and-Crafts-style home. A bold combination of exterior building
            materials elicits interest outside, while inside, a practical design
            creates space in the home's economical floor plan. To maximize
            space, the foyer, great room, dining room and kitchen are completely
            open to one another. A cathedral ceiling spans the great room and
            kitchen, expanding the rooms vertically. The bedrooms are split for
            ultimate master suite privacy, and a cathedral ceiling caps the
            master bedroom for an added sense of space. A bonus room, accessed
            near the master suite, offers options for storage and expansion. Two
            family bedrooms and a hall bath are located on the opposite of the
            home.
          </p>
        </div>
          ...
          <div className="similar-card row">
            ...
            <div className="home-box-container nopadding">
              <div className="box-image">
                ...
                <img src="./assets/view1.jpg" alt="featured" />
              </div>
              <div className="box-text">
                <h6>Town Home</h6>
                <div className="box-def">
