    ...
    <div className="container">
      <Carousel>
        <Carousel.Item interval={1000} className="sized">
          <img src="./assets/castle1.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/castle2.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/castle3.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/castle4.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/castle5.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/castle6.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/castle7.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/castle8.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/castle9.webp" alt="Featured-House" />
        </Carousel.Item>
        <Carousel.Item interval={500} className="sized">
          <img src="./assets/castle10.webp" alt="Featured-House" />
        </Carousel.Item>
      </Carousel>
      <div className="farm-one">
        <h2>1839 Honey Spring Place</h2>
        ...
        <div className="ranch-form">
          <h4>
            Monthly Rent <span>$25,000</span>
          </h4>

          <h4>
            Bedrooms<span>9Bedrooms</span>
          </h4>

          <h4>
            Bathrooms <span>9Bathrooms</span>
          </h4>

          <h4>
            Square Feet <span>10,558 SQ FT </span>
          </h4>
        </div>
        <div className="form-about">
          <h4>About Honey Spring Place</h4>
          <p>
